...
const ArticlesList = () => {
  ...
  return (
    <main className='main-content w-11/12 h-full m-auto text-center grid grid-cols-1 gap-4 border-none'>


      {articles ? articles.map(article => {
        return <div key={article.article_id} className="max-w-sm m-auto bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img className="rounded-t-lg" src={article.article_img_url} alt={article.title} />
          </a>
          <div className="p-5">
            <a href="#">
            ...
            <div className="container w-full flex justify-between items-center">
              <a href="#" className='inline-flex items-center text-red-600'>{article.topic.toUpperCase()}</a>
